...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 24.4 (中央値: 23.0, N=112)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 48.8 (中央値: 50.0, N=721)</li>
</ul>
</div>
...
<li>ロケットブルーム: 71回</li>
<li>悪魔の典籍: 63回</li>
<li>マジックコンバーター: 34回</li>
<li>蛍光の森: 28回</li>
<li>スターダスト・シャワー: 25回</li>
<li>ダンマクノート: 23回</li>
<li>アリオト: 21回</li>
<li>元素放射: 21回</li>
</ul></div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 45.8 (中央値: 46.0, N=483)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 54.6 (中央値: 61.0, N=1560)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 197.1 (中央値: 206.0, N=372)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">イリュージョンレーザー</span>: 44回</li>
...
<div class="shop-tendency-column">
<h4>所持金 151～300円 の場合 (N=240)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">逆張り</span>: 20回</li>
...
<li><span class="text-purchase">元素放射</span>: 10回</li>
<li><span class="text-purchase">ヤコウタケ</span>: 9回</li>
...
<li><span class="text-exhibit">レコード</span>: 2回</li>
...
<li><span class="text-remove">ショット</span>: 20回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 14回</li>
<li><span class="text-remove">結界</span>: 12回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">イリュージョンレーザー</span>: 14回</li>
