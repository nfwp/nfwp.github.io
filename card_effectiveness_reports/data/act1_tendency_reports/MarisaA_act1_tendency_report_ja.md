...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 23.5 (中央値: 23.0, N=107)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 48.3 (中央値: 50.0, N=688)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 45.7 (中央値: 46.0, N=460)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 54.4 (中央値: 61.0, N=1484)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 193.2 (中央値: 205.0, N=350)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">イリュージョンレーザー</span>: 43回</li>
...
<li><span class="text-purchase">ヤコウタケ</span>: 14回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">イリュージョンレーザー</span>: 115回</li>
