...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 23.4 (中央値: 21.0, N=110)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 48.5 (中央値: 50.0, N=675)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 46.1 (中央値: 47.0, N=465)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 54.5 (中央値: 61.0, N=1511)</li>
</ul>
...
<h3>3. ショップでの行動傾向</h3>
<ul><li><strong>ショップ訪問時の平均所持金</strong>: 243.3 (中央値: 206.0, N=375)</li></ul>
...
<ul>
<li><span class="text-remove">イリュージョンレーザー</span>: 42回</li>
...
<li><span class="text-purchase">悪魔の典籍</span>: 15回</li>
...
<li><span class="text-purchase">マジックコンバーター</span>: 14回</li>
<li><span class="text-purchase">ヤコウタケ</span>: 11回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">イリュージョンレーザー</span>: 13回</li>
