<h2>Act 1 プレイヤー行動傾向レポート: MarisaA</h2>
<h3>1. スキマでの行動傾向</h3>
<div class="tendency-container">
<div class="tendency-text">
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 23.0 (中央値: 21.0, N=107)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 48.3 (中央値: 50.0, N=672)</li>
</ul>
</div>
<div class="tendency-graph">
<img src="data/act1_tendency_images/MarisaA_gap_hp_distribution_ja.png" alt="MarisaA - Act 1 スキマ到着時HPの分布">
</div>
</div>
...
<li>ロケットブルーム: 66回</li>
<li>悪魔の典籍: 56回</li>
<li>マジックコンバーター: 31回</li>
<li>蛍光の森: 29回</li>
<li>借りてくぜ: 23回</li>
<li>アリオト: 22回</li>
<li>スターダスト・シャワー: 22回</li>
<li>ダンマクノート: 20回</li>
</ul></div>
<div class="column"><ul>
<li>元素放射: 19回</li>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 45.8 (中央値: 46.0, N=451)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 54.5 (中央値: 61.0, N=1483)</li>
</ul>
...
<td style='text-align: right;'><strong><span style='color: red;'>122.6</span></strong></td>
</tr>
<tr>
<td>アリオト</td>
...
<tr class="specialist-row">
<td><strong>🔥 ダイレクティドレイザー</strong></td>
...
<tr class="specialist-row">
<td><strong>🔥 ナビゲーションスター</strong></td>
...
<tr class="specialist-row">
<td><strong>🔥 サテライトイリュージョン</strong></td>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 192.4 (中央値: 205.0, N=358)</li>
</ul>
</div>
<div class="tendency-graph">
<img src="data/act1_tendency_images/MarisaA_shop_money_distribution_ja.png" alt="MarisaA - Act 1 ショップ訪問時所持金の分布" style="max-height: 100px; object-fit: contain;">
</div>
</div>

<div class="shop-tendency-container">
<div class="shop-tendency-column">
<h4>所持金 0～150円 の場合 (N=117)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">クリーンエネルギー</span>: 7回</li>
<li><span class="text-purchase">逆張り</span>: 7回</li>
<li><span class="text-purchase">ヤコウタケ</span>: 6回</li>
<li><span class="text-purchase">ロケットブルーム</span>: 5回</li>
...
<li><span class="text-purchase">紅内勁</span>: 2回</li>
...
<li><span class="text-purchase">🧰 使い捨ての護符</span>: 1回</li>
</ul>
</div>
<div class="shop-item-sub-column">
...
<ul>
<li><span class="text-remove">イリュージョンレーザー</span>: 41回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 9回</li>
<li><span class="text-remove">ショット</span>: 7回</li>
<li><span class="text-remove">ブルームディフェンス</span>: 4回</li>
...
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">🧰 水鉄砲</span>: 20回</li>
<li><span class="text-purchase">🧰 缶詰</span>: 17回</li>
<li><span class="text-purchase">クリーンエネルギー</span>: 13回</li>
<li><span class="text-purchase">逆張り</span>: 13回</li>
<li><span class="text-purchase">悪魔の典籍</span>: 13回</li>
<li><span class="text-purchase">🧰 ライオットシールド</span>: 13回</li>
<li><span class="text-purchase">ヤコウタケ</span>: 12回</li>
<li><span class="text-purchase">失敗の産物</span>: 11回</li>
<li><span class="text-purchase">マジックコンバーター</span>: 11回</li>
<li><span class="text-purchase">きゅうりミサイル</span>: 10回</li>
<li><span class="text-purchase">元素放射</span>: 9回</li>
<li><span class="text-purchase">借りてくぜ</span>: 8回</li>
<li><span class="text-purchase">冬日和</span>: 7回</li>
<li><span class="text-purchase">チャージ</span>: 7回</li>
<li><span class="text-purchase">ロケットブルーム</span>: 6回</li>
<li><span class="text-purchase">🧰 フロッピーディスク</span>: 6回</li>
<li><span class="text-purchase">原因不明の熱病</span>: 6回</li>
<li><span class="text-purchase">ダンマクノート</span>: 6回</li>
<li><span class="text-purchase">蛍光の森</span>: 6回</li>
<li><span class="text-purchase">ピッチダークサテライト</span>: 5回</li>
</ul>
</div>
<div class="shop-item-sub-column">
<h5> よく購入される展示品 Top 20
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">イリュージョンレーザー</span>: 111回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 17回</li>
<li><span class="text-remove">ショット</span>: 17回</li>
<li><span class="text-remove">結界</span>: 11回</li>
<li><span class="text-remove">ブルームディフェンス</span>: 8回</li>
...
<li><span class="text-purchase">山の如し</span>: 2回</li>
<li><span class="text-purchase">クリーンエネルギー</span>: 2回</li>
<li><span class="text-purchase">祝宴</span>: 1回</li>
...
<li><span class="text-purchase">炉心融解</span>: 1回</li>
<li><span class="text-purchase">マジックコンバーター</span>: 1回</li>
...
<li><span class="text-exhibit">石油</span>: 2回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">イリュージョンレーザー</span>: 12回</li>
<li><span class="text-remove">ショット</span>: 2回</li>
<li><span class="text-remove">ブルームディフェンス</span>: 1回</li>
<li><span class="text-remove">🌀 不幸</span>: 1回</li>
</ul>
</div>
</div>
