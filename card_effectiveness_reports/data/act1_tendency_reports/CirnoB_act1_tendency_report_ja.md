...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 29.5 (中央値: 29.0, N=206)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 50.5 (中央値: 51.0, N=821)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 47.5 (中央値: 48.0, N=545)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 56.4 (中央値: 61.0, N=1781)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 182.3 (中央値: 172.5, N=330)</li>
</ul>
</div>
<div class="tendency-graph">
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">フロストリーフ</span>: 15回</li>
