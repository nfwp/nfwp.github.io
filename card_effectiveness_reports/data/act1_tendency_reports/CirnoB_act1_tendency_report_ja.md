...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 29.2 (中央値: 28.0, N=207)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 50.6 (中央値: 51.0, N=821)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 47.6 (中央値: 48.5, N=536)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 56.4 (中央値: 61.0, N=1788)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 183.5 (中央値: 173.0, N=330)</li>
</ul>
</div>
<div class="tendency-graph">
...
<li><span class="text-purchase">知性なる妖精</span>: 1回</li>
...
<ul>
<li><span class="text-remove">フロストリーフ</span>: 26回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">フロストリーフ</span>: 108回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">フロストリーフ</span>: 17回</li>
