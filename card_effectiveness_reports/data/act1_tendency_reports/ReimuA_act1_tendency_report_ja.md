...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 40.8 (中央値: 40.0, N=115)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 58.5 (中央値: 61.0, N=1133)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 56.0 (中央値: 58.5, N=718)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 62.7 (中央値: 69.0, N=1944)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 167.7 (中央値: 161.0, N=274)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">博麗アミュレット</span>: 52回</li>
