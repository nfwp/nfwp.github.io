...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 39.5 (中央値: 40.0, N=125)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 58.6 (中央値: 61.0, N=1220)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 56.1 (中央値: 58.0, N=780)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 62.7 (中央値: 69.0, N=2109)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 168.4 (中央値: 154.0, N=318)</li>
</ul>
</div>
<div class="tendency-graph">
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">博麗アミュレット</span>: 69回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">博麗アミュレット</span>: 7回</li>
