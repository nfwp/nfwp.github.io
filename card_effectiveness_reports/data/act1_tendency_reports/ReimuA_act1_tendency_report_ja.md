...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 39.4 (中央値: 40.0, N=132)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 58.7 (中央値: 61.0, N=1264)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 56.2 (中央値: 59.0, N=805)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 62.7 (中央値: 69.0, N=2169)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 171.6 (中央値: 156.0, N=323)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">博麗アミュレット</span>: 60回</li>
...
<li><span class="text-purchase">紅内勁</span>: 6回</li>
