...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 25.3 (中央値: 23.0, N=114)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.9 (中央値: 47.0, N=501)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 45.0 (中央値: 45.0, N=405)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 53.3 (中央値: 58.0, N=1205)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 209.1 (中央値: 212.0, N=269)</li>
</ul>
</div>
<div class="tendency-graph">
...
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">🧰 缶詰</span>: 22回</li>
...
<li><span class="text-purchase">原因不明の熱病</span>: 11回</li>
...
<li><span class="text-exhibit">銀の懐中時計</span>: 6回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">二重らせん</span>: 68回</li>
