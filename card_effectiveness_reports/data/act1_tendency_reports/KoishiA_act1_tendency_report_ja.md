...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 24.8 (中央値: 23.0, N=111)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 47.2 (中央値: 47.0, N=434)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 44.9 (中央値: 45.0, N=358)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 53.1 (中央値: 58.0, N=1064)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 206.6 (中央値: 210.0, N=241)</li>
</ul>
</div>
<div class="tendency-graph">
...
<li><span class="text-purchase">出まかせ</span>: 13回</li>
...
<li><span class="text-purchase">本能の愛</span>: 4回</li>
...
<li><span class="text-remove">ショット</span>: 28回</li>
