...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 24.1 (中央値: 23.0, N=107)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 47.2 (中央値: 47.0, N=443)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 45.0 (中央値: 45.5, N=362)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 53.2 (中央値: 58.0, N=1072)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 207.5 (中央値: 210.0, N=242)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">二重らせん</span>: 18回</li>
...
<div class="shop-tendency-column">
<h4>所持金 151～300円 の場合 (N=160)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">🧰 缶詰</span>: 19回</li>
<li><span class="text-purchase">色褪せた夢</span>: 16回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">二重らせん</span>: 62回</li>
