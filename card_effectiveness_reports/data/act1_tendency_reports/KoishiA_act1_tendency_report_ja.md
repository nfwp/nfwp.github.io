...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 25.3 (中央値: 24.0, N=105)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.8 (中央値: 47.0, N=465)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 45.0 (中央値: 45.0, N=369)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 53.5 (中央値: 58.0, N=1112)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 211.6 (中央値: 212.0, N=250)</li>
</ul>
</div>
<div class="tendency-graph">
...
<li><span class="text-purchase">フィルドミアズマ</span>: 2回</li>
...
<div class="shop-tendency-column">
<h4>所持金 151～300円 の場合 (N=168)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">🧰 缶詰</span>: 20回</li>
<li><span class="text-purchase">色褪せた夢</span>: 15回</li>
...
<li><span class="text-remove">自閉</span>: 4回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">二重らせん</span>: 16回</li>
