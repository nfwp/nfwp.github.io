...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 23.2 (中央値: 23.0, N=82)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.4 (中央値: 47.0, N=355)</li>
</ul>
</div>
...
<li>アステロイドベルト: 27回</li>
<li>ヤコウタケ: 17回</li>
<li>スターダスト・シャワー: 16回</li>
<li>悪魔の典籍: 15回</li>
<li>スピードバトル: 15回</li>
<li>アリオト: 13回</li>
</ul></div>
<div class="column"><ul>
<li>マジックコンバーター: 13回</li>
<li>紅内勁: 10回</li>
<li>逆張り: 10回</li>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 43.5 (中央値: 44.0, N=253)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 52.7 (中央値: 57.0, N=833)</li>
</ul>
...
<tr class="specialist-row">
<td><strong>🔥 浮世の関を超える山姥</strong></td>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 203.2 (中央値: 210.0, N=200)</li>
</ul>
</div>
<div class="tendency-graph">
...
<li><span class="text-purchase">シュート・ザ・ムーン</span>: 4回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">スターインパクト</span>: 58回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">スターインパクト</span>: 7回</li>
