...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 22.7 (中央値: 22.5, N=80)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.1 (中央値: 47.0, N=345)</li>
</ul>
</div>
...
<li>バーニングレーザー: 43回</li>
<li>ダンマクノート: 28回</li>
<li>シュート・ザ・ムーン: 28回</li>
<li>アステロイドベルト: 27回</li>
<li>スターダスト・シャワー: 18回</li>
<li>悪魔の典籍: 16回</li>
<li>スピードバトル: 15回</li>
<li>ヤコウタケ: 12回</li>
<li>マジックコンバーター: 12回</li>
</ul></div>
<div class="column"><ul>
<li>アリオト: 12回</li>
<li>紅内勁: 10回</li>
<li>逆張り: 8回</li>
<li>スターダストレヴァリエ: 7回</li>
<li>冬日和: 6回</li>
<li>満月の咆哮: 6回</li>
<li>借りてくぜ: 5回</li>
<li>原因不明の熱病: 5回</li>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 43.5 (中央値: 44.0, N=248)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 52.7 (中央値: 57.5, N=812)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 206.4 (中央値: 211.0, N=187)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">スターインパクト</span>: 16回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 5回</li>
<li><span class="text-remove">スターダストディフェンス</span>: 3回</li>
...
<li><span class="text-purchase">逆張り</span>: 3回</li>
</ul>
</div>
<div class="shop-item-sub-column">
<h5> よく購入される展示品 Top 20
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">スターインパクト</span>: 56回</li>
...
<div class="shop-tendency-column">
<h4>所持金 301～円 の場合 (N=19)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">借りてくぜ</span>: 4回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">スターインパクト</span>: 8回</li>
