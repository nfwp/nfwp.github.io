...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 23.9 (中央値: 23.5, N=78)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.0 (中央値: 47.0, N=349)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 43.4 (中央値: 43.5, N=250)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 53.0 (中央値: 58.0, N=812)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 203.7 (中央値: 209.0, N=190)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">スターインパクト</span>: 10回</li>
...
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">ダンマクノート</span>: 15回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">スターインパクト</span>: 5回</li>
