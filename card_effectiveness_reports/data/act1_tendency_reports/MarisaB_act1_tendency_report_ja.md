...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 24.3 (中央値: 24.0, N=86)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.6 (中央値: 47.0, N=382)</li>
</ul>
</div>
...
<li>ロケットブルーム: 65回</li>
<li>バーニングレーザー: 50回</li>
<li>シュート・ザ・ムーン: 30回</li>
<li>ダンマクノート: 26回</li>
<li>アステロイドベルト: 24回</li>
<li>スターダスト・シャワー: 21回</li>
<li>ヤコウタケ: 17回</li>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 43.9 (中央値: 44.0, N=272)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 52.9 (中央値: 57.0, N=902)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 207.1 (中央値: 212.0, N=210)</li>
</ul>
</div>
<div class="tendency-graph">
...
<li><span class="text-purchase">スピードバトル</span>: 13回</li>
...
<li><span class="text-purchase">借りてくぜ</span>: 7回</li>
...
<li><span class="text-purchase">冬日和</span>: 5回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">スターインパクト</span>: 70回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 13回</li>
<li><span class="text-remove">結界</span>: 9回</li>
