...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 23.3 (中央値: 23.0, N=79)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.1 (中央値: 47.0, N=342)</li>
</ul>
</div>
...
<li>無差別発火の符: 5回</li>
<li>蛍光の森: 5回</li>
<li>ブライトスターリースカイ: 4回</li>
</ul></div>
</div>
<h3>2. エリートマスへの挑戦傾向</h3>
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 43.7 (中央値: 44.0, N=246)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 52.8 (中央値: 58.0, N=807)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 206.9 (中央値: 212.0, N=187)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">スターインパクト</span>: 15回</li>
...
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">ダンマクノート</span>: 17回</li>
