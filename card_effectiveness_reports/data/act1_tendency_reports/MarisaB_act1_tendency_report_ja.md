<h2>Act 1 プレイヤー行動傾向レポート: MarisaB</h2>
<h3>1. スキマでの行動傾向</h3>
<div class="tendency-container">
<div class="tendency-text">
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 22.9 (中央値: 23.0, N=85)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.2 (中央値: 47.0, N=378)</li>
</ul>
</div>
<div class="tendency-graph">
<img src="data/act1_tendency_images/MarisaB_gap_hp_distribution_ja.png" alt="MarisaB - Act 1 スキマ到着時HPの分布">
</div>
</div>
...
<li>ダンマクノート: 29回</li>
<li>アステロイドベルト: 26回</li>
<li>シュート・ザ・ムーン: 25回</li>
<li>悪魔の典籍: 19回</li>
<li>スターダスト・シャワー: 19回</li>
<li>スピードバトル: 17回</li>
<li>ヤコウタケ: 16回</li>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 43.2 (中央値: 44.0, N=271)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 53.1 (中央値: 57.0, N=883)</li>
</ul>
...
<td style='text-align: right;'><strong><span style='color: red;'>137.4</span></strong></td>
</tr>
<tr class="specialist-row">
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 201.0 (中央値: 209.0, N=203)</li>
</ul>
</div>
<div class="tendency-graph">
<img src="data/act1_tendency_images/MarisaB_shop_money_distribution_ja.png" alt="MarisaB - Act 1 ショップ訪問時所持金の分布" style="max-height: 100px; object-fit: contain;">
</div>
</div>

<div class="shop-tendency-container">
<div class="shop-tendency-column">
<h4>所持金 0～150円 の場合 (N=50)</h4>
...
<li><span class="text-purchase">ダンマクノート</span>: 2回</li>
...
<ul>
<li><span class="text-remove">スターインパクト</span>: 18回</li>
...
<li><span class="text-purchase">🧰 電子ドラム</span>: 4回</li>
...
<li><span class="text-exhibit">日傘</span>: 1回</li>
</ul>
</div>
<div class="shop-item-sub-column">
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">スターインパクト</span>: 59回</li>
...
<li><span class="text-purchase">ヤコウタケ</span>: 2回</li>
...
<li><span class="text-purchase">鬼気怒濤</span>: 1回</li>
...
<li><span class="text-exhibit">ガムテープ</span>: 1回</li>
</ul>
</div>
<div class="shop-item-sub-column">
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">スターインパクト</span>: 9回</li>
