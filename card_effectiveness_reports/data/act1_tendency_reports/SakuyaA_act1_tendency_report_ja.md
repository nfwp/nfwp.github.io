...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 22.2 (中央値: 21.0, N=185)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.4 (中央値: 47.0, N=663)</li>
</ul>
</div>
...
<div class="column"><ul>
<li>一休み: 21回</li>
<li>イマジナリバーチカルタイム: 19回</li>
<li>シルバーエレガント: 18回</li>
<li>銀色のアナザーディメンジョン: 17回</li>
<li>跳弾するナイフ: 15回</li>
<li>デジャヴ: 14回</li>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 44.1 (中央値: 45.0, N=523)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 53.7 (中央値: 59.0, N=1648)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 213.5 (中央値: 226.5, N=460)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">フェイント投げ</span>: 37回</li>
