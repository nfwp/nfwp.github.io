<h2>Act 1 プレイヤー行動傾向レポート: SakuyaA</h2>
<h3>1. スキマでの行動傾向</h3>
<div class="tendency-container">
<div class="tendency-text">
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 22.8 (中央値: 22.0, N=220)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.1 (中央値: 47.0, N=736)</li>
</ul>
</div>
<div class="tendency-graph">
<img src="data/act1_tendency_images/SakuyaA_gap_hp_distribution_ja.png" alt="SakuyaA - Act 1 スキマ到着時HPの分布">
</div>
</div>
...
<li>聖地巡礼: 59回</li>
<li>危険な手品師: 52回</li>
<li>チェンジリングマジック: 39回</li>
<li>シルバープッシュ: 39回</li>
<li>降雪決行: 38回</li>
<li>浄化活動: 31回</li>
<li>イマジナリバーチカルタイム: 29回</li>
<li>時間厳守: 26回</li>
<li>捏造報道: 25回</li>
</ul></div>
<div class="column"><ul>
...
<li>一休み: 20回</li>
<li>シルバーエレガント: 20回</li>
<li>銀色のアナザーディメンジョン: 19回</li>
<li>跳弾するナイフ: 18回</li>
<li>デジャヴ: 17回</li>
<li>プリンセスウンディネ: 16回</li>
<li>イカサマ: 15回</li>
<li>星剣の舞: 15回</li>
<li>聖人化: 14回</li>
</ul></div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 43.4 (中央値: 44.0, N=586)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 53.7 (中央値: 59.0, N=1839)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 212.8 (中央値: 226.0, N=519)</li>
</ul>
</div>
<div class="tendency-graph">
<img src="data/act1_tendency_images/SakuyaA_shop_money_distribution_ja.png" alt="SakuyaA - Act 1 ショップ訪問時所持金の分布" style="max-height: 100px; object-fit: contain;">
</div>
</div>

<div class="shop-tendency-container">
<div class="shop-tendency-column">
<h4>所持金 0～150円 の場合 (N=140)</h4>
...
<li><span class="text-purchase">部屋掃除</span>: 6回</li>
<li><span class="text-purchase">聖地巡礼</span>: 5回</li>
<li><span class="text-purchase">降雪決行</span>: 5回</li>
<li><span class="text-purchase">瀟洒なメイド</span>: 5回</li>
<li><span class="text-purchase">ディフレクション</span>: 5回</li>
<li><span class="text-purchase">水遊び</span>: 5回</li>
<li><span class="text-purchase">時間厳守</span>: 4回</li>
<li><span class="text-purchase">準備</span>: 4回</li>
<li><span class="text-purchase">イマジナリバーチカルタイム</span>: 3回</li>
<li><span class="text-purchase">捏造報道</span>: 3回</li>
<li><span class="text-purchase">船底の念縛霊</span>: 3回</li>
...
<li><span class="text-purchase">月相</span>: 2回</li>
...
<p>- この価格帯での行動データはありませんでした。</p>
</div>
<div class="shop-item-sub-column">
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">フェイント投げ</span>: 49回</li>
<li><span class="text-remove">ショット</span>: 17回</li>
<li><span class="text-remove">危険予知</span>: 17回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 10回</li>
</ul>
</div>
</div>
</div>
<div class="shop-tendency-column">
<h4>所持金 151～300円 の場合 (N=326)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">🧰 缶詰</span>: 26回</li>
<li><span class="text-purchase">クリーンエネルギー</span>: 23回</li>
<li><span class="text-purchase">🧰 ライオットシールド</span>: 20回</li>
<li><span class="text-purchase">聖地巡礼</span>: 19回</li>
<li><span class="text-purchase">時間厳守</span>: 18回</li>
<li><span class="text-purchase">部屋掃除</span>: 18回</li>
<li><span class="text-purchase">🧰 水鉄砲</span>: 18回</li>
<li><span class="text-purchase">歴史喰い</span>: 17回</li>
<li><span class="text-purchase">降雪決行</span>: 16回</li>
<li><span class="text-purchase">シルバープッシュ</span>: 15回</li>
<li><span class="text-purchase">危険な手品師</span>: 14回</li>
<li><span class="text-purchase">イマジナリバーチカルタイム</span>: 13回</li>
<li><span class="text-purchase">準備</span>: 12回</li>
<li><span class="text-purchase">チェンジリングマジック</span>: 11回</li>
<li><span class="text-purchase">拘束時間</span>: 10回</li>
<li><span class="text-purchase">一休み</span>: 9回</li>
<li><span class="text-purchase">🧰 バックパック</span>: 9回</li>
<li><span class="text-purchase">水遊び</span>: 8回</li>
<li><span class="text-purchase">ダモクレスの刃</span>: 8回</li>
<li><span class="text-purchase">きゅうりミサイル</span>: 8回</li>
</ul>
</div>
<div class="shop-item-sub-column">
<h5> よく購入される展示品 Top 20
<ul>
<li><span class="text-exhibit">銀の懐中時計</span>: 12回</li>
<li><span class="text-exhibit">リボン</span>: 7回</li>
<li><span class="text-exhibit">会員証</span>: 6回</li>
<li><span class="text-exhibit">実験器具</span>: 4回</li>
<li><span class="text-exhibit">空き瓶</span>: 4回</li>
<li><span class="text-exhibit">おみくじ</span>: 2回</li>
<li><span class="text-exhibit">天狗の携帯</span>: 2回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">フェイント投げ</span>: 188回</li>
<li><span class="text-remove">ショット</span>: 31回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 22回</li>
<li><span class="text-remove">危険予知</span>: 19回</li>
...
<li><span class="text-purchase">シルバープッシュ</span>: 5回</li>
<li><span class="text-purchase">🧰 ライオットシールド</span>: 5回</li>
<li><span class="text-purchase">瀟洒なメイド</span>: 4回</li>
<li><span class="text-purchase">プリンセスウンディネ</span>: 4回</li>
<li><span class="text-purchase">部屋掃除</span>: 4回</li>
<li><span class="text-purchase">準備</span>: 4回</li>
<li><span class="text-purchase">時間厳守</span>: 3回</li>
<li><span class="text-purchase">歴史喰い</span>: 3回</li>
<li><span class="text-purchase">チェンジリングマジック</span>: 3回</li>
...
<li><span class="text-purchase">🧰 フロッピーディスク</span>: 2回</li>
...
<h5> よく購入される展示品 Top 20
<ul>
<li><span class="text-exhibit">銀の懐中時計</span>: 4回</li>
<li><span class="text-exhibit">実験器具</span>: 4回</li>
...
<li><span class="text-exhibit">芍薬</span>: 2回</li>
<li><span class="text-exhibit">ぶどう</span>: 1回</li>
<li><span class="text-exhibit">空き瓶</span>: 1回</li>
<li><span class="text-exhibit">精巧なティーセット</span>: 1回</li>
<li><span class="text-exhibit">楼観剣</span>: 1回</li>
<li><span class="text-exhibit">ソウルジェム</span>: 1回</li>
<li><span class="text-exhibit">お団子</span>: 1回</li>
<li><span class="text-exhibit">スマートスピーカー</span>: 1回</li>
<li><span class="text-exhibit">鴉天狗の羽根</span>: 1回</li>
<li><span class="text-exhibit">ひみつのマント</span>: 1回</li>
<li><span class="text-exhibit">ドリームキャッチャー</span>: 1回</li>
<li><span class="text-exhibit">ライトセイバー</span>: 1回</li>
<li><span class="text-exhibit">黒のノート</span>: 1回</li>
</ul>
</div>
<div class="shop-item-sub-column">
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">フェイント投げ</span>: 28回</li>
...
<li><span class="text-remove">危険予知</span>: 1回</li>
</ul>
</div>
</div>
</div>
