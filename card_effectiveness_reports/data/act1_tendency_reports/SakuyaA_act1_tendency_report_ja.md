...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 22.6 (中央値: 21.0, N=199)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 46.1 (中央値: 47.0, N=675)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 43.8 (中央値: 45.0, N=536)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 53.7 (中央値: 59.0, N=1681)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 215.8 (中央値: 228.0, N=470)</li>
</ul>
</div>
<div class="tendency-graph">
...
<div class="shop-tendency-column">
<h4>所持金 151～300円 の場合 (N=291)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">🧰 缶詰</span>: 29回</li>
...
<li><span class="text-purchase">クリーンエネルギー</span>: 15回</li>
<li><span class="text-purchase">部屋掃除</span>: 14回</li>
...
<li><span class="text-purchase">プリンセスウンディネ</span>: 8回</li>
...
<li><span class="text-remove">ショット</span>: 29回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 23回</li>
<li><span class="text-remove">危険予知</span>: 16回</li>
