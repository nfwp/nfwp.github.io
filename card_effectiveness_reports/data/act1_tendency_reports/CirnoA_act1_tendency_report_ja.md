...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 32.7 (中央値: 26.0, N=63)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 53.6 (中央値: 55.0, N=588)</li>
</ul>
</div>
...
<div class="column"><ul>
<li>猛吹雪: 62回</li>
<li>タイニーグレイシャー: 57回</li>
<li>審念熟慮: 36回</li>
<li>友を呼ぶ: 28回</li>
<li>氷漬けの標本: 26回</li>
<li>アイスシールド: 25回</li>
<li>プリンセスウンディネ: 24回</li>
<li>氷上の妖精: 19回</li>
<li>薄氷を踏む: 19回</li>
<li>捏造報道: 17回</li>
</ul></div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 52.0 (中央値: 52.0, N=460)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 60.0 (中央値: 67.0, N=1213)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 180.9 (中央値: 167.0, N=259)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">アイスショット</span>: 45回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">アイスショット</span>: 96回</li>
