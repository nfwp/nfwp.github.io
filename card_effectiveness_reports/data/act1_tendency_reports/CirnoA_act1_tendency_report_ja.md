...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 33.3 (中央値: 26.0, N=66)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 53.4 (中央値: 55.0, N=606)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 51.6 (中央値: 52.0, N=478)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 60.0 (中央値: 67.0, N=1262)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 179.7 (中央値: 166.0, N=273)</li>
</ul>
</div>
<div class="tendency-graph">
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">アイスショット</span>: 103回</li>
