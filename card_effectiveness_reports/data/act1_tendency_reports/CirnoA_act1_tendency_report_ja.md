...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 34.2 (中央値: 28.0, N=83)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 52.7 (中央値: 53.0, N=676)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 51.4 (中央値: 52.0, N=543)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 59.9 (中央値: 66.0, N=1436)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 185.5 (中央値: 171.0, N=315)</li>
</ul>
</div>
<div class="tendency-graph">
...
<li><span class="text-purchase">かき氷の売り子、大妖精</span>: 5回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">アイスショット</span>: 107回</li>
