...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 34.0 (中央値: 27.0, N=76)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 53.5 (中央値: 55.0, N=668)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 52.2 (中央値: 53.0, N=532)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 60.2 (中央値: 67.0, N=1397)</li>
</ul>
...
<td style='text-align: right;'><strong><span style='color: red;'>132.0</span></strong></td>
</tr>
<tr>
<td>氷上の妖精</td>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 179.7 (中央値: 167.0, N=307)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">アイスショット</span>: 50回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">アイスショット</span>: 114回</li>
