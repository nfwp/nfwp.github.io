...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 26.3 (中央値: 24.0, N=126)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 48.2 (中央値: 49.0, N=592)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 44.9 (中央値: 45.0, N=467)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 54.4 (中央値: 60.0, N=1276)</li>
</ul>
<h4>2.1 Act 1 エリート挑戦・性能カード分析 (Top 40)</h4>
<p>エリート挑戦率が高い上位40カードを表示します。その中で、挑戦率が平均より高く、かつエリート戦での性能（攻防偏差値合計）が110以上の**エリート特効カードを太字**で示します。</p>
...
<h3>3. ショップでの行動傾向</h3>
<ul><li><strong>ショップ訪問時の平均所持金</strong>: 203.6 (中央値: 206.0, N=338)</li></ul>
...
<ul>
<li><span class="text-remove">溢れ出る愛</span>: 50回</li>
