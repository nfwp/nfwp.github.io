<h2>Act 1 プレイヤー行動傾向レポート: KoishiB</h2>
<h3>1. スキマでの行動傾向</h3>
<div class="tendency-container">
<div class="tendency-text">
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 27.1 (中央値: 25.0, N=123)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 47.9 (中央値: 49.0, N=609)</li>
</ul>
</div>
<div class="tendency-graph">
<img src="data/act1_tendency_images/KoishiB_gap_hp_distribution_ja.png" alt="KoishiB - Act 1 スキマ到着時HPの分布">
</div>
</div>
...
<li>春植えざれば秋実らず: 8回</li>
<li>暗闇演舞: 8回</li>
<li>ロマンスの夜のラストコール: 7回</li>
<li>色褪せた夢: 7回</li>
</ul></div>
</div>
<h3>2. エリートマスへの挑戦傾向</h3>
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 44.7 (中央値: 45.0, N=474)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 54.2 (中央値: 60.0, N=1319)</li>
</ul>
...
<tr class="specialist-row">
<td><strong>🔥 疑惑のティーパーティー</strong></td>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 201.3 (中央値: 201.0, N=347)</li>
</ul>
</div>
<div class="tendency-graph">
<img src="data/act1_tendency_images/KoishiB_shop_money_distribution_ja.png" alt="KoishiB - Act 1 ショップ訪問時所持金の分布" style="max-height: 100px; object-fit: contain;">
</div>
</div>

<div class="shop-tendency-container">
<div class="shop-tendency-column">
<h4>所持金 0～150円 の場合 (N=120)</h4>
...
<li><span class="text-purchase">閉じた心</span>: 6回</li>
...
<li><span class="text-purchase">幻想郷の開花</span>: 2回</li>
<li><span class="text-purchase">孤独な心</span>: 2回</li>
<li><span class="text-purchase">サバイバル本能</span>: 2回</li>
<li><span class="text-purchase">スイートポテトルーム</span>: 2回</li>
<li><span class="text-purchase">胎児の夢</span>: 1回</li>
<li><span class="text-purchase">鈴蘭の花園</span>: 1回</li>
<li><span class="text-purchase">サブタレイニアンローズ</span>: 1回</li>
<li><span class="text-purchase">春植えざれば秋実らず</span>: 1回</li>
<li><span class="text-purchase">被害妄想</span>: 1回</li>
<li><span class="text-purchase">暗闇演舞</span>: 1回</li>
</ul>
</div>
<div class="shop-item-sub-column">
...
<ul>
<li><span class="text-remove">溢れ出る愛</span>: 53回</li>
...
<div class="shop-tendency-column">
<h4>所持金 151～300円 の場合 (N=175)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">🧰 缶詰</span>: 21回</li>
<li><span class="text-purchase">🧰 ライオットシールド</span>: 20回</li>
<li><span class="text-purchase">🧰 水鉄砲</span>: 16回</li>
<li><span class="text-purchase">閉じた心</span>: 14回</li>
<li><span class="text-purchase">孤独な心</span>: 11回</li>
<li><span class="text-purchase">クリーンエネルギー</span>: 11回</li>
<li><span class="text-purchase">原因不明の熱病</span>: 10回</li>
<li><span class="text-purchase">スイートポテトルーム</span>: 9回</li>
<li><span class="text-purchase">悪魔の典籍</span>: 9回</li>
<li><span class="text-purchase">无寿の夢</span>: 9回</li>
<li><span class="text-purchase">被害妄想</span>: 7回</li>
<li><span class="text-purchase">出まかせ</span>: 7回</li>
<li><span class="text-purchase">鈴蘭の花園</span>: 6回</li>
<li><span class="text-purchase">熱情の追憶</span>: 6回</li>
<li><span class="text-purchase">高鳴る鼓動</span>: 6回</li>
<li><span class="text-purchase">春植えざれば秋実らず</span>: 6回</li>
<li><span class="text-purchase">DNAの瑕</span>: 6回</li>
<li><span class="text-purchase">蛍光の夜</span>: 5回</li>
<li><span class="text-purchase">無我</span>: 5回</li>
<li><span class="text-purchase">いばらの舞</span>: 4回</li>
</ul>
</div>
<div class="shop-item-sub-column">
<h5> よく購入される展示品 Top 20
<ul>
<li><span class="text-exhibit">博麗アミュレット</span>: 6回</li>
<li><span class="text-exhibit">リボン</span>: 6回</li>
<li><span class="text-exhibit">おいしいクッキー</span>: 4回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">溢れ出る愛</span>: 85回</li>
...
<li><span class="text-remove">百花繚乱</span>: 5回</li>
<li><span class="text-remove">🌀 嫉妬</span>: 1回</li>
<li><span class="text-remove">🌀 不幸</span>: 1回</li>
</ul>
</div>
...
<div class="shop-tendency-column">
<h4>所持金 301～円 の場合 (N=52)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">🧰 缶詰</span>: 8回</li>
<li><span class="text-purchase">🧰 水鉄砲</span>: 8回</li>
<li><span class="text-purchase">閉じた心</span>: 5回</li>
<li><span class="text-purchase">出まかせ</span>: 5回</li>
<li><span class="text-purchase">原因不明の熱病</span>: 5回</li>
<li><span class="text-purchase">🧰 バックパック</span>: 4回</li>
<li><span class="text-purchase">スイートポテトルーム</span>: 4回</li>
<li><span class="text-purchase">孤独な心</span>: 3回</li>
<li><span class="text-purchase">悪魔の典籍</span>: 3回</li>
...
<li><span class="text-purchase">蛍光の夜</span>: 2回</li>
<li><span class="text-purchase">被害妄想</span>: 2回</li>
</ul>
</div>
<div class="shop-item-sub-column">
<h5> よく購入される展示品 Top 20
<ul>
<li><span class="text-exhibit">リボン</span>: 5回</li>
<li><span class="text-exhibit">天狗の羽団扇</span>: 4回</li>
<li><span class="text-exhibit">タケコプター</span>: 4回</li>
<li><span class="text-exhibit">会員証</span>: 3回</li>
<li><span class="text-exhibit">黒のノート</span>: 3回</li>
...
<li><span class="text-exhibit">空き瓶</span>: 1回</li>
<li><span class="text-exhibit">自転車</span>: 1回</li>
<li><span class="text-exhibit">雛人形</span>: 1回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">溢れ出る愛</span>: 21回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 6回</li>
<li><span class="text-remove">🌀 不幸</span>: 4回</li>
<li><span class="text-remove">結界</span>: 2回</li>
