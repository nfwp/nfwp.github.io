<h2>Act 1 プレイヤー行動傾向レポート: SakuyaB</h2>
<h3>1. スキマでの行動傾向</h3>
<div class="tendency-container">
<div class="tendency-text">
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 26.4 (中央値: 25.5, N=192)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 47.9 (中央値: 49.0, N=606)</li>
</ul>
</div>
<div class="tendency-graph">
<img src="data/act1_tendency_images/SakuyaB_gap_hp_distribution_ja.png" alt="SakuyaB - Act 1 スキマ到着時HPの分布">
</div>
</div>
<h4>Gap/Shopでの優先強化カード Top 20</h4>
<div class="two-column-container">
<div class="column"><ul>
<li>イマジナリバーチカルタイム: 55回</li>
<li>聖地巡礼: 49回</li>
<li>離剣乱舞: 34回</li>
<li>危険な手品師: 31回</li>
<li>チェンジリングマジック: 30回</li>
<li>ダモクレスの刃: 28回</li>
<li>ジャック・ザ・ルドビレ: 26回</li>
<li>咲夜特製ストップウォッチ: 22回</li>
<li>捏造報道: 22回</li>
<li>部屋掃除: 22回</li>
</ul></div>
<div class="column"><ul>
<li>星剣の舞: 22回</li>
<li>プリンセスウンディネ: 20回</li>
<li>浄化活動: 18回</li>
<li>プライベートヴィジョン: 15回</li>
<li>イカサマ: 14回</li>
<li>タイムマジック: 14回</li>
<li>空間幻術: 13回</li>
<li>Ｃ．リコシェ: 12回</li>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 44.7 (中央値: 46.0, N=374)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 55.9 (中央値: 61.0, N=1554)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 209.7 (中央値: 224.0, N=370)</li>
</ul>
</div>
<div class="tendency-graph">
<img src="data/act1_tendency_images/SakuyaB_shop_money_distribution_ja.png" alt="SakuyaB - Act 1 ショップ訪問時所持金の分布" style="max-height: 100px; object-fit: contain;">
</div>
</div>

<div class="shop-tendency-container">
<div class="shop-tendency-column">
<h4>所持金 0～150円 の場合 (N=104)</h4>
...
<li><span class="text-purchase">浄化活動</span>: 2回</li>
...
<li><span class="text-purchase">空間幻術</span>: 1回</li>
<li><span class="text-purchase">ティータイム</span>: 1回</li>
<li><span class="text-purchase">空想具現化</span>: 1回</li>
</ul>
</div>
<div class="shop-item-sub-column">
...
<ul>
<li><span class="text-remove">トランプ射撃</span>: 25回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 13回</li>
<li><span class="text-remove">黒鍵パリィ</span>: 10回</li>
...
<div class="shop-tendency-column">
<h4>所持金 151～300円 の場合 (N=230)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">🧰 缶詰</span>: 25回</li>
<li><span class="text-purchase">ジャック・ザ・ルドビレ</span>: 23回</li>
<li><span class="text-purchase">🧰 水鉄砲</span>: 23回</li>
<li><span class="text-purchase">🧰 ライオットシールド</span>: 15回</li>
<li><span class="text-purchase">きゅうりミサイル</span>: 14回</li>
...
<li><span class="text-purchase">イマジナリバーチカルタイム</span>: 9回</li>
<li><span class="text-purchase">プリンセスウンディネ</span>: 9回</li>
<li><span class="text-purchase">聖地巡礼</span>: 8回</li>
<li><span class="text-purchase">準備</span>: 8回</li>
<li><span class="text-purchase">船底の念縛霊</span>: 7回</li>
<li><span class="text-purchase">ティータイム</span>: 7回</li>
<li><span class="text-purchase">タイムマジック</span>: 7回</li>
<li><span class="text-purchase">月相</span>: 7回</li>
<li><span class="text-purchase">時間厳守</span>: 7回</li>
...
<h5> よく購入される展示品 Top 20
<ul>
<li><span class="text-exhibit">銀の懐中時計</span>: 9回</li>
...
<li><span class="text-exhibit">タケコプター</span>: 2回</li>
<li><span class="text-exhibit">天狗の携帯</span>: 2回</li>
<li><span class="text-exhibit">木魚</span>: 2回</li>
<li><span class="text-exhibit">ブロックアイス</span>: 2回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">トランプ射撃</span>: 111回</li>
<li><span class="text-remove">🌀 忍び寄る飢餓</span>: 18回</li>
<li><span class="text-remove">ショット</span>: 17回</li>
<li><span class="text-remove">黒鍵パリィ</span>: 9回</li>
<li><span class="text-remove">結界</span>: 1回</li>
...
<div class="shop-tendency-column">
<h4>所持金 301～円 の場合 (N=36)</h4>
<div class="shop-item-grid">
<div class="shop-item-sub-column">
<h5> よく購入されるカード Top 20
<ul>
<li><span class="text-purchase">ジャック・ザ・ルドビレ</span>: 6回</li>
<li><span class="text-purchase">クリーンエネルギー</span>: 6回</li>
...
<li><span class="text-purchase">ティータイム</span>: 3回</li>
<li><span class="text-purchase">🧰 ライオットシールド</span>: 3回</li>
<li><span class="text-purchase">水遊び</span>: 3回</li>
<li><span class="text-purchase">静穏</span>: 3回</li>
<li><span class="text-purchase">賢者の帰依</span>: 2回</li>
<li><span class="text-purchase">浄化活動</span>: 2回</li>
...
<li><span class="text-exhibit">ひらり布</span>: 2回</li>
<li><span class="text-exhibit">黒のノート</span>: 1回</li>
<li><span class="text-exhibit">空き瓶</span>: 1回</li>
<li><span class="text-exhibit">ルナティックガン</span>: 1回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">トランプ射撃</span>: 15回</li>
<li><span class="text-remove">ショット</span>: 4回</li>
