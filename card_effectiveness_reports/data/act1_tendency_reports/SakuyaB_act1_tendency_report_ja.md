...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 26.5 (中央値: 26.0, N=192)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 47.9 (中央値: 49.0, N=607)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 44.7 (中央値: 46.0, N=376)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 55.8 (中央値: 61.0, N=1559)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 210.3 (中央値: 224.0, N=373)</li>
</ul>
</div>
<div class="tendency-graph">
...
<li><span class="text-purchase">プリンセスウンディネ</span>: 10回</li>
...
<li><span class="text-purchase">タイムマジック</span>: 8回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">トランプ射撃</span>: 112回</li>
