...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 37.2 (中央値: 35.5, N=84)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 53.9 (中央値: 56.0, N=701)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 50.7 (中央値: 51.0, N=425)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 61.2 (中央値: 68.0, N=1308)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 178.3 (中央値: 166.0, N=205)</li>
</ul>
</div>
<div class="tendency-graph">
...
<ul>
<li><span class="text-remove">御札ショット</span>: 30回</li>
...
<li><span class="text-purchase">無差別発火の符</span>: 3回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">御札ショット</span>: 43回</li>
