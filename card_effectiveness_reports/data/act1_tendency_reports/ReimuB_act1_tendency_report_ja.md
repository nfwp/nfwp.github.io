...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 36.7 (中央値: 35.0, N=80)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 53.6 (中央値: 56.0, N=693)</li>
</ul>
</div>
...
<ul>
<li><strong>エリート挑戦時の平均HP</strong>: 50.6 (中央値: 51.0, N=412)</li>
<li><strong>通常戦闘選択時の平均HP</strong>: 60.7 (中央値: 67.0, N=1295)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 181.6 (中央値: 176.5, N=198)</li>
</ul>
</div>
<div class="tendency-graph">
...
<li><span class="text-purchase">作戦姿勢</span>: 1回</li>
</ul>
</div>
<div class="shop-item-sub-column">
...
<ul>
<li><span class="text-remove">御札ショット</span>: 29回</li>
