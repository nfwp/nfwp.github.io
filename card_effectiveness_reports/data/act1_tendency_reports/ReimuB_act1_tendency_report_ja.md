...
<ul>
<li><strong>休憩（回復）を選択した時の平均HP</strong>: 38.2 (中央値: 36.0, N=75)</li>
<li><strong>カード強化を選択した時の平均HP</strong>: 53.8 (中央値: 56.0, N=676)</li>
</ul>
</div>
...
<li><strong>通常戦闘選択時の平均HP</strong>: 61.4 (中央値: 68.0, N=1246)</li>
</ul>
...
<div class="tendency-text">
<ul>
<li><strong>ショップ訪問時の平均所持金</strong>: 179.9 (中央値: 167.0, N=191)</li>
</ul>
</div>
<div class="tendency-graph">
...
<li><span class="text-remove">弾幕退治</span>: 5回</li>
...
<li><span class="text-purchase">心抄斬</span>: 5回</li>
...
<li><span class="text-purchase">幻想辺境</span>: 2回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">御札ショット</span>: 40回</li>
...
<h5> よく削除されるカード Top 20
<ul>
<li><span class="text-remove">御札ショット</span>: 4回</li>
